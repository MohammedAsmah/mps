...
<body style="background:#dfe8ff">
	...
	?>
	<form id="form" name="form" method="post" action="palmares_clients_com_v.php">
	...
	*/
	...
	$sql .= "FROM commandes where date_e between '$date' and '$date1' and evaluation<>'$vide' and evaluation<>'$encours' and vendeur='$vendeur' GROUP BY client order by total DESC;";
...
echo "Palmares Clients $vendeur $du au $au "; ?></span>
