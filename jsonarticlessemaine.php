...
<?php
	...
	$sql .= "FROM detail_commandes where produit='$produit' and week(NOW()) = week(date) and year(NOW()) = year(date) and escompte_exercice=0 GROUP BY client order by total_quantite DESC;";
