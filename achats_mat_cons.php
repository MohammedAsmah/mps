<?php
	...
	if(isset($_REQUEST["action_"]) && $profile_id == 1) { 
		...
		switch($_REQUEST["action_"]) {
			...
			case "insert_new_user":
				...
				$d=dateFrToUs(date("d/m/Y"));$mat="mat_cons";
	...
	?>
	<form id="form" name="form" method="post" action="achats_mat_cons.php">
...
<script type="text/javascript"><!--
	function EditUser(user_id) { document.location = "achat_mat_cons.php?user_id=" + user_id; }
--></script>
...
<? $t=0;while($users_ = fetch_array($users)) {?><tr>
	...
	<td align="center"><?php echo number_format($users_["prix_achat"],4,',',' ');?></td>
		<td align="right"><?php $t=$t+$users_["prix_achat"]*$users_["qte"];echo number_format($users_["prix_achat"]*$users_["qte"],2,',',' ');?></td>	
