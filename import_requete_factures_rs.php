...
while (!feof($fp))
{
  ...
  $liste[13] = ( isset($liste[13]) ) ? $liste[13] : Null;
	...
	if ($champs1!='')
		...
		$query = "INSERT INTO factures_riad (id,date,numero,montant,mode,type,nuites,pax,total_nuites,taxe,sejour,prix_unit,nom,arrivee,depart,mois)
		VALUES('','$champs0','$champs1','$champs2','$champs3','$champs4','$champs5','$champs6','$champs7','$champs8','$champs9','$champs10','$champs11','$champs12','$champs13','$mois')";  
