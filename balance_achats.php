...
<body style="background:#dfe8ff">
	...
	?>
	<form id="form" name="form" method="post" action="balance_achats.php">
	...
	$sql .= "FROM achats_mat where date between '$date' and '$date1' GROUP BY produit;";
...
<? echo "<td><a href=\"balance_achats_details.php?produit=$produit&date=$date&date1=$date1\">$produit</a></td>";?>
