...
$pdf->addText(194, 695, 14, 'C.M ');
$pdf->addText(224, 695, 14, 'C.A ');
...
$pdf->addText(470, 695, 14, 'Observation');
	...
	while($users11_ = fetch_array($user1)) { 
		$produit=$users11_["produit"];$condit=$users11_["condit"];$qte=0;$coche="....";
   ...
   $pdf->addText(198, $ligne, 10, $coche);
   $pdf->addText(227, $ligne, 10, $coche);
...
$pdf->line(250, $ligne, 250, 710);
$pdf->line(190, $ligne, 190, 710);
$pdf->line(220, $ligne, 220, 710);
