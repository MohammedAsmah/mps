...
$pdf->Cell(70,14,'Despatching Couleurs',1,0,'L',1);
...
$pdf->SetX(85);$d="QUANTITE ";
$pdf->Cell(10,9,$d,0,0,'L',1);

$pdf->SetY(48);$pdf->SetX(109);$d=" MARRON ";
$pdf->Cell(30,9,$d,0,0,'L',1);
$pdf->SetY(48);$pdf->SetX(136);$d="  BEIGE  ";
$pdf->Cell(30,9,$d,0,0,'L',1);
$pdf->SetY(48);$pdf->SetX(170);$d=" GRIS  ";
...
$ligne=65;$pdf->Line(3,60,3,65);$pdf->Line(205,60,205,65);
	...
	while($users11_ = fetch_array($user1)) { 
		...
		$total=$total+($qte*$condit*$prix);$marron=$users11_["marron"];$gris=$users11_["gris"];$beige=$users11_["beige"];
	...
	$pdf->Cell(10,6,$qte*$condit,0,0,'L',1);$pdf->SetX(130);
	$pdf->Cell(10,6,$marron,0,0,'L',1);$pdf->SetX(150);
	$pdf->Cell(20,6,$gris,0,0,'L',1);$pdf->SetX(175);
	$pdf->Cell(30,6,$beige,0,0,'L',1);
