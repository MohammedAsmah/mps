...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression ?"; ?>")) {
			document.location = "edition_factures_backup.php?action_=delete_user&du=<?php echo $du; ?>&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<span style="font-size:24px"><?php $numero=$user_id;echo "Facture : ".$numero."---".$date."---".$client; ?></span>

<form id="form_user" name="form_user" method="post" action="edition_factures_backup.php">
