...
while (!feof($fp))
{
  ...
  $liste[9] = ( isset($liste[9]) ) ? $liste[9] : Null;
	...
	$champs0=$liste[0]; $champs_v="2008";
	$champs1=$liste[1]; 
	$champs2=$liste[2];
    $champs3= dateFrToUs($liste[3]);$champs33= $liste[3];
	$champs4=$liste[4]; 
	$champs5=$liste[5];
	$champs6=$liste[6];
	$r1=$liste[7]; 
	...
	if ($champs1!='')
		...
		$query = "INSERT INTO commandes (id,champs1,commande,client,vendeur,date,date_e,remise_10,remise_2,remise_3,net,evaluation,bondesortie)
		VALUES('','$champs_v','$champs0','$champs1','$champs2','$champs33','$champs3','$r1','$r2','$r3','$champs4','$champs5','$champs6')";  
  		...
  		if (mysql_error())
			...
			<table width="505" border="1" align="center" cellpadding="0" cellspacing="0" bgcolor="#eeeeee">
    			<tr>
      				...
      				<td width="361"><?php echo $liste[0]."-". $liste[1]."-". $liste[2]."-". $liste[3]."-". $liste[4]."-". $liste[5];?></td>
    			</tr>
			</table>
			<?php
			}
