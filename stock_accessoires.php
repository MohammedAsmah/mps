<?php
	...
	<form id="form" name="form" method="post" action="stock_accessoires.php">
...
<span style="font-size:24px"><?php $jour=date("d/m/y");$d=$_POST["date1"];echo "Etat de Stock Accessoires Au : $d"; ?></span>
...
<?php $id=$users_["id"];$produit=$users_["produit"];$stock_controle=$users_["stock_controle"];$type=$users_["type"];$stock_initial=$users_["stock_ini_exe"];$stock_initial_jp=$users_["stock_initial_jp"];?>
...
<tr>
<td bgcolor="#66CCCC"><? $user_id=$users_["id"];echo "<a href=\"fiche_de_stock_a.php?date=$date1&user_id=$user_id\">".$produit."</a>"; ?></td>
<td bgcolor="#66CCCC"><?php if(!$stock_controle) { echo "    N.C"; }; ?></td>
<td bgcolor="#66CCCC"><?php echo $e_depot_a-$s_depot_a+$e_depot_a_se+$stock_initial; ?></td>
<td bgcolor="#66CCCC"><?php echo $e_depot_b-$s_depot_b+$e_depot_b_se+$stock_initial_jp; ?></td>
<td bgcolor="#66CCCC"><?php echo ($e_depot_a-$s_depot_a+$e_depot_a_se+$stock_initial)+($e_depot_b-$s_depot_b+$e_depot_b_se+$stock_initial_jp); ?></td>

<td bgcolor="#66CCCC"><? $user_id=$users_["id"];echo "<a href=\"fiche_de_stock_sa.php?date=$date1&user_id=$user_id\">sorties</a>"; ?></td>
<?php 

//mise à jour stock
$stock_simulation=($e_depot_a-$s_depot_a+$e_depot_a_se+$stock_initial)+($e_depot_b-$s_depot_b+$e_depot_b_se+$stock_initial_jp);
$stock_mps=$e_depot_a-$s_depot_a+$e_depot_a_se+$stock_initial;$stock_jp=$e_depot_b-$s_depot_b+$e_depot_b_se+$stock_initial_jp;
...
<p></p>
<td bgcolor="#66CCCC"><? echo "<a href=\"editer_stock_accessoires.php?du=$du&date1=$date1\">Imprimer</a>"; ?></td>
