<?php
	...
	<form id="form" name="form" method="post" action="etat_avances_employes.php">
	<table>
	...
	$date_f=dateFrToUs($_POST['date']);$du=$_POST['date'];$au=$_POST['date2'];
		...
		$sql  = "SELECT * ";
		$sql .= "FROM avances_employes where date_avance between '$date' and '$date2' and type='$type' ORDER BY id;";
...
<span style="font-size:24px"><?php echo "Avances employes : ".$du." au ".$au; ?></span>
