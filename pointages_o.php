<?php
	...
	{
?>
	<form id="form" name="form" method="post" action="pointages_o.php">
	...
	as t_jeu,sum(ven) as t_ven,sum(sam) as t_sam,sum(dim) as t_dim,sum(lun_s) as t_lun_s ,sum(mar_s) as t_mar_s,sum(mer_s) as t_mer_s,sum(jeu_s) 
	as t_jeu_s,sum(ven_s) as t_ven_s,sum(sam_s) as t_sam_s,sum(dim_s) as t_dim_s,sum(heures) as t_heures ";
...
<table class="table2">
<tr>
<td><?php echo $users_["t_sam_s"]; ?></td>
<td><?php echo $users_["t_dim_s"]; ?></td>
<td><?php echo $users_["t_lun_s"]; ?></td>
<td><?php echo $users_["t_mar_s"]; ?></td>
<td><?php echo $users_["t_mer_s"]; ?></td>
<td><?php echo $users_["t_jeu_s"]; ?></td>
<td><?php echo $users_["t_ven_s"]; ?></td>
