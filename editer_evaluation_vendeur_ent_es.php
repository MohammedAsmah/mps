<?php
	...
	$id = $numero;
		...
		$vendeur = $user_["vendeur"];$remise10 = $user_["remise_10"];$remise2 = $user_["remise_2"];$escompte = $user_["escompte"];$escompte2 = $user_["escompte2"];
...
$pdf->SetY(20);$pdf->SetX(5);$d="Vendeur : ".$vendeur;
$pdf->Cell(40,10,$d,0,0,'L',1);

$pdf->SetY(15);$pdf->SetX(100);$d="Destination : ".$ville;
$pdf->Cell(40,10,$d,0,0,'L',1);

$pdf->SetY(28);$pdf->SetX(5);$d="Client : ".$client;
$pdf->Cell(40,10,$d,0,0,'L',1);

$pdf->SetY(35);$pdf->SetX(90);$d="Numero :  ".$bon_sortie;
$pdf->Cell(30,10,$d,0,0,'L',1);

$pdf->SetY(35);$pdf->SetX(145);$d="Evaluation : ".$evaluation;
$pdf->Cell(30,10,$d,0,0,'L',1);
$pdf->SetFont('arial','B',12);
$pdf->SetY(48);$pdf->SetX(8);$d="  Designation Article  ";
$pdf->Cell(50,10,$d,0,0,'L',1);
$pdf->SetY(48);$pdf->SetX(67);$d="  Nbre Paquets  ";
$pdf->Cell(30,10,$d,0,0,'L',1);
$pdf->SetY(48);$pdf->SetX(100);$d="  Quantite  ";
$pdf->Cell(30,10,$d,0,0,'L',1);
$pdf->SetY(48);$pdf->SetX(122);$d="  Px Unit.";
$pdf->Cell(15,10,$d,0,0,'L',1);
$pdf->SetY(48);$pdf->SetX(145);$d="  Remise";
$pdf->Cell(15,10,$d,0,0,'L',1);
$pdf->SetY(48);$pdf->SetX(166);$d="  Px Net";
$pdf->Cell(15,10,$d,0,0,'L',1);
$pdf->SetY(48);$pdf->SetX(184);$d="  Total  ";
...
if ($sans_remise==1){
					...
					if ($escompte>0){
					$d="     Escompte  $escompte % : ". number_format($net*$escompte/100,2,',',' ');
					$pdf->SetY($ligne+$h);$pdf->SetX($x);$h=$h+5;$es1=$net*$escompte/100;
					$pdf->Cell(30,6,$d,0,0,'R',1);
					
					if ($escompte2>0){
					$d="2eme Escompte  $escompte % : ". number_format(($net-$es1)*$escompte2/100,2,',',' ');
					$pdf->SetY($ligne+$h);$pdf->SetX($x);$h=$h+5;$es2=($net-$es1)*$escompte2/100;
					$pdf->Cell(30,6,$d,0,0,'R',1);
					$d="                      Net  : ". number_format(($net-$es1-$es2),2,',',' ');
					$pdf->SetY($ligne+$h);$pdf->SetX($x);$h=$h+5;
					$pdf->Cell(30,6,$d,0,0,'R',1);
					}
					
					$d="               Net a payer : ". number_format(($net-$es1-$es2),2,',',' ');
					$pdf->SetY($ligne+$h);$pdf->SetX($x);$h=$h+5;
					$pdf->Cell(30,6,$d,0,0,'R',1);
					}
...
//////
				$d="                  Net a payer : ". number_format($net+$total1-($es1+$es2),2,',',' ');
					...
					$pdf->Cell(30,6,$evaluation,0,0,'R',1);
