...
$du_f=dateUsToFr($du1);$au_f=dateUsToFr($au1);$titre="Production $produit / $machine du $du_f au $au_f";
...
$res1 = mysql_query("SELECT prod_14_22,prod_6_14,prod_22_6,date from details_productions where date between '$du1' and '$au1' and produit='$produit' and machine='$machine' order by date", $link);
$tab1=array();
while($ligne1= mysql_fetch_array ($res1)) {
	$pp=$ligne1['prod_6_14']+$ligne1['prod_14_22']+$ligne1['prod_22_6'];
	array_push($tab1,$pp);
