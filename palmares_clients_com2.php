...
<body style="background:#dfe8ff">
	...
	?>
	<form id="form" name="form" method="post" action="palmares_clients_com2.php">
...
while($users_ = fetch_array($users)) { $total=$users_["total"];if ($total>$plafond){?>
...
$montant=$users_["total"]-$net_avoir;
