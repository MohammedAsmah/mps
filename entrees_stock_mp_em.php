<?php
	...
	$error_message = "";$famille="EMBALLAGES ET CONSOMMABLES";
	...
	?>
	<form id="form" name="form" method="post" action="entrees_stock_mp_em.php">
	...
	$sql  = "SELECT * ";$type="reception";$date=dateFrToUs($_POST['date']);$mp3="EMBALLAGES ET CONSOMMABLES";
	$sql .= "FROM entrees_stock_mp where date='$date' and type='$type' and famille='$mp3' ORDER BY date,id;";
	$users = db_query($database_name, $sql);}
	else
	{	$sql  = "SELECT * ";$type="reception";$dj="2021-12-27";$mp3="EMBALLAGES ET CONSOMMABLES";
	$sql .= "FROM entrees_stock_mp where type='$type' and date>='$dj' and famille='$mp3' ORDER BY date,id;";
	$users = db_query($database_name, $sql);}
...
<script type="text/javascript"><!--
	function EditUser(user_id) { document.location = "entree_stock_mp_em.php?user_id=" + user_id; }
--></script>
...
<table><tr><td>
<? if ($date<>""){echo "<a href=\"entree_stock_mp_em.php?date=$date&user_id=0\">Ajout Reception</a></td>";}?></tr><tr>
