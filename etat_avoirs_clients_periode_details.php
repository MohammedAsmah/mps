<?php
	...
	$profiles_list_vendeur = "";$vendeur="";
		...
		$sql  = "SELECT * ";
		$sql .= "FROM detail_avoirs where client='$client' and date between '$date_du' and '$date_au' and produit='$produit' ORDER BY date DESC;";
...
<span style="font-size:24px"><?php echo "Detail Avoirs Du $date_du_fr Au $date_au_fr   -  $client / $produit "; ?></span>
...
<?php $produit=$users1_["produit"]; $id=$users1_["id"];?>
		...
		<td align="center"><?php echo $users1_["quantite"]*$users1_["condit"];$total_quantite=$total_quantite+$users1_["quantite"]*$users1_["condit"]; ?></td></tr>
