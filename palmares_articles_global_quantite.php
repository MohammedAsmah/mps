...
<body style="background:#dfe8ff">
	...
	?>
	<form id="form" name="form" method="post" action="palmares_articles_global_quantite.php">
	...
	$sql .= "FROM detail_commandes where date between '$date' and '$date1' and evaluation<>'$vide' GROUP BY produit order by t_quantite DESC;";
	...
	$sql .= "FROM detail_commandes where date between '$date' and '$date1' and evaluation<>'$vide' and evaluation<>'$encours' GROUP BY produit order by t_quantite DESC;";
	$users = db_query($database_name, $sql);
...
<td align="right"><?php @$nq= number_format($net/$pp,2,',',' ');$nqt=$nqt+$nq;print("<font size=\"1\" face=\"Comic sans MS\" color=\"#000033\">$nq </font>");?></td>
