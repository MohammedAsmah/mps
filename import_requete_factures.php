...
while (!feof($fp))
{
  ...
  $liste[4] = ( isset($liste[4]) ) ? $liste[4] : Null;
   $liste[5] = ( isset($liste[5]) ) ? $liste[5] : Null;
	...
	$champs0=$liste[0]; $champs_v="sejour";$cours=11;$devise="MAD";
	$champs1=$liste[1]; 
	$champs2=$liste[2];
    $champs3= $liste[3];
	$champs4=$liste[4]; 
	...
	if ($champs1!='')
		...
		/*$query = "INSERT INTO  liste_factures_ventes_import (id,champs1,numero,evaluation,date,montant,client)
		VALUES('','$champs_v','$champs0','$champs1','$champs2','$champs3','$champs4')";  
  		$result= mysql_query($query);*/
		
		$query = "INSERT INTO  liste_factures_ventes_import (id,numero,date_facture,booking_customer,booking_number,booking_name,montant_facture,type_facture,cours,devise)
		VALUES('','$champs0','$champs1','$champs5','$champs2','$champs3','$champs4','$champs6','$cours','$devise')";  
  		$result= mysql_query($query);
