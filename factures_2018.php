...
/// update evaluations
	...
	<form id="form" name="form" method="post" action="factures_2018.php">
...
<script type="text/javascript"><!--
	function EditUser(user_id) { document.location = "facture_2018.php?user_id=" + user_id; }
...
echo "<td><a href=\"facture_2018.php?user_id=$user_id&date_f=$date_f&client=$client&facture=$facture&du=$du&au=$au\">$facture1</a></td>";?>
...
<? if ($login=="admin"){echo "<td><a href=\"facture_2018.php?user_id=0&du=$du&au=$au\">Nouvelle Facture</a></td>";}?>
</body>
