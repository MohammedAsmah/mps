<?php
	...
	$id = $numero;
		...
		$vendeur = $user_["vendeur"];$remise10 = $user_["remise_10"];$remise2 = $user_["remise_2"];$escompte = $user_["escompte"];
...
$pdf->SetY(30+$entete);$pdf->SetX(10);$d="Client : ".$client."   ESCOMPTE CLIENT EXERCICE 2023";
$pdf->Cell(40,10,$d,0,0,'L',1);

$pdf->SetFont('arial','B',12);
$pdf->SetY(46+$entete);$pdf->SetX(10);$d="  Designation Article  ";
$pdf->Cell(50,10,$d,0,0,'L',1);
$pdf->SetY(46+$entete);$pdf->SetX(93);$d="  Nbre Paquets  ";
...
$ligne=55+$entete;
	...
	$pdf->SetY($ligne);	
	$pdf->Cell(50,6,$produit,0,0,'L',1);$pdf->SetX(95);
	$pdf->Cell(10,6,$qte,0,0,'L',1);$pdf->SetX(105);
	$pdf->Cell(10,6,' X ',0,0,'L',1);$pdf->SetX(117);
...
if ($sans_remise==1){
	...
	if ($escompte>0){
					...
					$pdf->SetY($ligne+$h);$pdf->SetX($x);$h=$h+5;
					$pdf->Cell(30,6,$d,0,0,'L',1);
					$d="Net a payer : ". number_format($net-($net*$escompte/100),2,',',' ');
					$pdf->SetY($ligne+$h);$pdf->SetX($x);$h=$h+5;
					$pdf->Cell(30,6,$d,0,0,'L',1);
					}
