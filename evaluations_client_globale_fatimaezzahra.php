...
set_time_limit(0);
	...
	?>
	<form id="form" name="form" method="post" action="evaluations_client_globale_fatimaezzahra.php">
...
<tr>
	...
	<th><?php echo "commitment_date";?></th>
...
$bondesortie=$users_["bondesortie"];$numero_f=$users_["facture"];$ville=$users_["ville"];
...
<?php $produit=$users1_["produit"]; $id=$users1_["id"];$m=$users1_["quantite"]*$users1_["prix_unit"]*$users1_["condit"];
		...
		echo "<tr><td></td><td>$client</td><td>$ville</td><td>$date_e</td><td>$vendeur</td><td>$produit</td><td>$qty</td><td>$net3</td></tr>";
