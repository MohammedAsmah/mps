<?php
	...
	if(isset($_REQUEST["action_"]) && $profile_id == 1) { 
		...
		switch($_REQUEST["action_"]) {
			...
			case "insert_new_user":
				...
				$d=dateFrToUs(date("d/m/Y"));$eti="eti";
	...
	?>
	<form id="form" name="form" method="post" action="achats_eti.php">
...
<script type="text/javascript"><!--
	function EditUser(user_id) { document.location = "achat_eti.php?user_id=" + user_id; }
--></script>
...
<span style="font-size:24px"><?php echo "Achats Etiquettes"; ?></span>
...
<? $t=0;while($users_ = fetch_array($users)) {?><tr>
	...
	<td align="center"><?php echo number_format($users_["prix_achat"],3,',',' ');?></td>
		<td align="right"><?php $t=$t+$users_["prix_achat"]*$users_["qte"];echo number_format($users_["prix_achat"]*$users_["qte"],3,',',' ');?></td>	
