...
<? 	
	...
	$sql .= "FROM porte_feuilles where m_cheque<>0 and remise=0 and chq_f=1 and date_cheque>'$dd' GROUP BY client order by total_cheque;";
...
while($users_1 = fetch_array($users11)) { 
			...
			<? echo "<tr><td><a href=\"porte_feuilles_details_clients.php?client=$client\">$client</a></td>";
