...
while($users_1 = fetch_array($users11)) { $id_r=$users_1["id"];$date_enc=$users_1["date"];$vendeur=$users_1["vendeur"];
	...
	$total_fa=number_format($total_fa,2,',',' ');
			...
			<? echo "<td><a href=\"reglements.php?bon_sortie=$observation&id_registre=$id_r&date_enc=$date_enc&vendeur=$vendeur&date1=$de1&date2=$de2\">$total_eval</a></td>";
			 echo "<td><a href=\"reglements1.php?id_registre=$id_r&date_enc=$date_enc&vendeur=$vendeur&bon_sortie=$observation&date1=$de1&date2=$de2\">$total_fa</a></td>";
 } ?>
