...
<? 	
	...
	$sql  = "SELECT id,date_enc,date_cheque,client,client_tire_e,v_banque_e,numero_effet,sum(m_effet) As total_cheque ";
	$sql .= "FROM porte_feuilles where date_echeance='$date' and m_effet<>0 and remise_e=0 and facture_n<>0 GROUP BY numero_effet;";
	$users11 = db_query($database_name, $sql);
