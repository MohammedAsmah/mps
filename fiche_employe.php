<?php
	...
	if($user_id == "0") {
		...
		$date_embauche="";$date_naissance="";$conge=0;$conge_du="";$conge_au="";$tectra=0;
...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression ?"; ?>")) {
			document.location = "fiches_employes.php?action_=delete_user&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<form id="form_user" name="form_user" enctype="multipart/form-data" method="post" action="fiches_employes.php">
...
<table class="table2"><tr><td style="text-align:center">
	...
	<center>
		...
		<tr><td><?php echo "Heures sup : "; ?><input type="text" id="t_h_25" name="t_h_25" style="width:60px" value="<?php echo $t_h_25; ?>"></td>
		</td>
		<td>
		...
		<tr><td><?php echo "Type"; ?><select id="service" name="service"><?php echo $profiles_list_s; ?></select></td>
		<tr><td><?php echo "Poste"; ?><select id="poste" name="poste"><?php echo $profiles_list_poste; ?></select></td>
		<tr>
		...
		<tr>
		<td><?php echo "Tectra"; ?><input type="checkbox" id="tectra" name="tectra"<?php if($tectra) { echo " checked"; } ?>></td>
		</tr>
		<tr>
		...
		<tr>
		<td><?php echo "Situation Famille"; ?><input type="text" id="situation_famille" name="situation_famille" style="width:260px" value="<?php echo $situation_famille; ?>"></td>
		</tr>
