...
while (!feof($fp))
{
  ...
  $liste[8] = ( isset($liste[8]) ) ? $liste[8] : Null;
	...
	if ($champs1!='')
		...
		$query = "INSERT INTO clients (id,champs1,ref,client,vendeur,adrresse,remise2,remise3,ville,pièce,numero)
		VALUES('','$champs_v','$champs0','$champs1','$champs2','$champs3','$champs4','$champs5','$champs6','$champs7','$champs8')";  
