...
<?php if($login <> "adminrecap" and $login <> "stock" and $login <> "noureddine" and $login <> "ahmed" and $login <> "tamir" and $login <> "cherkaoui") { ?>
...
<tr></tr>
	...
	<tr></tr>
	<td style="width:10px"></td>
	<td><a href="produits_v.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Liste Articles </font>"); ?>]</a></td>
	</tr>	
...
<?php if($login == "admin" ) { ?>	
	...
	<td style="width:10px"></td>
	<td><a href="produits_dispo.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Liste dispo </font>"); ?>]</a></td>
	</tr>
	...
	<td style="width:10px"></td>
	<td><a href="clients_adr.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Liste Clients </font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<tr></tr>
	<td style="width:10px"></td>
	...
	<tr>
	<td style="width:10px"></td>
	<td><a href="http://152.228.170.97:8069" target="_Blank">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Ajout Bon Besoin   </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="machines.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Liste Machines </font>"); ?>]</a></td>
	...
	<tr>
	<td style="width:10px"></td>
	<td><a href="entrees_stock_barcode_jp_g.php" target="_blank">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Production G ==> JAOUDA </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="entrees_stock_barcode_jp_p.php" target="_blank">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Production P ==> JAOUDA </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="entrees_stock_barcode_mps_g.php" target="_blank">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Production G ==> MPS </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="entrees_stock_barcode_mps_p.php" target="_blank">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Production P ==> MPS </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="entrees_stock_barcode_jp_g_test.php" target="_blank">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">test barcode </font>"); ?>]</a></td>
	</tr>
	<?php if($login == "admin") { ?>
	<tr>
	<td style="width:10px"></td>
	<td><a href="importer_production_odoo.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Importer Production </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="entrer_fichier_production.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Importer Production C </font>"); ?>]</a></td>
	</tr>
	...
	<tr>
	<td style="width:10px"></td>
	<td><a href="mise_a_jour_stock_app.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Etat de Stock App</font>"); ?>]</a></td>
	</tr>
	...
	<tr>
	<td style="width:10px"></td>
	<td><a href="etat_stock_mp_sortie.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Etat Sortie Matiere </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="etat_stock_col_sortie.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Etat Sortie colorants </font>"); ?>]</a></td>
	</tr>
	
	
	<?php if($login == "admin" or $login == "rakia" or $login == "driss") { ?>
	<tr>
	<td style="width:10px"></td>
...
<?php if($tout == 1 or $menu13==1) { ?>
	...
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="porte_feuilles_factures.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Porte Feuilles Cheques/D</font>"); ?>]</a></td>
	</tr>	<tr></tr>
		</tr>	<tr></tr>	
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="porte_feuilles_factures_numero.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Porte Feuilles Cheques/N</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	
	<tr></tr>	
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="porte_feuilles_factures_clients.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Porte Feuilles Cheques/C</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	...
	<?php if($login == "admin" or $login == "nezha" or $login == "driss" or $login == "arahal" or $login == "fatimaezzahra") { ?>
	<tr>
	<td style="width:10px"></td>
	<td><a href="machines.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Liste Machines </font>"); ?>]</a></td>
	</tr>
	<?php if($login == "admin" or $login == "nezha" or $login == "driss" or $login == "rakia" or $login == "fatimaezzahra") { ?>
	<tr></tr>
	<td style="width:10px"></td>
	<td><a href="cv_ouvriers.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">CV Ouvriers </font>"); ?>]</a></td>
	</tr>
	<tr></tr>
	<td style="width:10px"></td>
	<td><a href="programmes.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Programme Semaine </font>"); ?>]</a></td>
	</tr>	
	<tr>
	<td style="width:10px"></td>
	...
	<?php if($login == "admin" or $login == "nezha" or $login == "driss" or $login="fatimaezzahra"){?>
	</tr>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	...
	<tr>
	<td style="width:10px"></td>
	<td><a href="entrees_stock_mp_em.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Entrees stock EMB </font>"); ?>]</a></td>
	</tr>
	
	<tr>
	<td style="width:10px"></td>
	<td><a href="sorties_stock_mp_em.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Sorties stock EMB </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	...
	<tr>
	<td style="width:10px"></td>
	<td><a href="etat_stock_mp_em.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Etat Stock EMB </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="etat_stock_mp.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Etat Stock MP </font>"); ?>]</a></td>
	...
	<tr>
	<td style="width:10px"></td>
	<td><a href="maintenances.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Saisie Intervention </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="machines.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Liste Machines </font>"); ?>]</a></td>
	</tr>
	<?php if($login == "admin" or $login == "driss" or $login == "zineb" or $login == "nezha"){?>
	<tr>
	<td style="width:10px"></td>
	<td><a href="fiches_globales_moules.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Liste Moules </font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	...
	<td style="width:10px"></td>
	<td><a href="importer_commandes.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Importer commandes</font>"); ?>]</a></td>
	</tr><tr>
	<td style="width:10px"></td>
	<td><a href="camions.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Liste Camions </font>"); ?>]</a></td>
	</tr>	<tr></tr>
	...
	<tr>
	<td style="width:10px"></td>
	<td><a href="commande_app.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Importer commandes</font>"); ?>]</a></td>
	</tr>
	<tr>
	<td style="width:10px"></td>
	<td><a href="evaluations_client_test.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">commandes importes</font>"); ?>]</a></td>
	</tr>
	...
	<tr></tr>
	<? if($login == "admin" or $login == "najat" or $login == "rakia" or $login == "Radia" or $login == "mghari") {?>
	<td style="width:10px"></td><? $v="ventes";?>
	...
	<td style="width:10px"></td>
	<td><a href="evaluations_client_solde.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Mise � jour soldes</font>"); ?>]</a></td>
	</tr>
	</tr>
	<td style="width:10px"></td>
	...
	<td style="width:10px"></td>
	<td><a href="fiches_employes_globales.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Personnes b�n�fici�re</font>"); ?>]</a></td>
	</tr>
	<?php if($login == "admin" or $login == "rakia")
	{ ?>
	<td style="width:10px"></td>
...
<? }?>	
	...
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="evaluations_transport_dates.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Etat Transport</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="soldes_clients_globale.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Soldes Clients</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="comptes_vendeurs.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Soldes Vendeurs</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<?php if($login == "admin"){?>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="evaluations_client_globale_odoo.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">odoo1</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	...
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="palmares_des_clients_2008.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Balance Crois�e 2008</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="palmares_des_clients_2009.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Balance Crois�e 2009</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="palmares_vendeurs_clients.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Generer Balance Crois�e</font>"); ?>]</a></td>
	...
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="palmares_secteurs.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Palmares des Villes</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	...
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="releves_factures_avoirs.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Relevé des avoirs </font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	...
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="edition_factures_backup_dupliquer.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Dupliquer Factures</font>"); ?>]</a></td>
	</tr>	
	<? }?>
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	...
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="emballages_sachets.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Poids Sachets</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="releves_factures_edition.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Imprimer Factures</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	...
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="ca_par_quantite_expert.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">CA en Quantités Expert</font>"); ?>]</a></td>
	</tr>	<tr></tr>
...
<? if($login == "admin"){ ?>
	...
	<? if ($login=="admin" or $login=="alaoui"){?>
	<td style="width:10px"></td>
	<td><a href="cloture_paie_semaine.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Cloture Paie </font>"); ?>]</a></td>
	</tr>	<tr></tr>	
	<tr></tr>
	<td style="width:10px"></td>
...
<?php if($login == "admin" ) { ?>	
	...
	<tr></tr>
	<td style="width:10px"></td>
	<td><a href="programmes.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Programmes </font>"); ?>]</a></td>
	</tr>		
	<tr></tr>
	
<? }?>

<?php if($login == "admin" or $login=="rakia" or $login=="najat" or $login=="alaoui" or $login=="fatimaezzahra" ) { ?>	
	<tr></tr>
	<td style="width:10px"></td>
	<td><a href="fiches_employes_mps.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Fichier Employes </font>"); ?>]</a></td>
	</tr>
	<tr></tr>	
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="pointage_jour_ferier.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Pointage Jour Ferier </font>"); ?>]</a></td>
	</tr>	<tr></tr>	
	<tr></tr>		
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="h_sup_jour_ferier_per.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">H.Sup Permanents J.F </font>"); ?>]</a></td>
	</tr>	<tr></tr>	
	<tr></tr>		
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="h_sup_jour_ferier_occ.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">H.Sup Tectra J.F</font>"); ?>]</a></td>
	</tr>	<tr></tr>	
	<tr></tr>
	<td style="width:10px"></td>
	...
	<tr></tr>
	<td style="width:10px"></td>
	<td><a href="etat_decompte_globale.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Decompte </font>"); ?>]</a></td>
	</tr>	
	<tr></tr>
	<td style="width:10px"></td>
	<td><a href="maj_decomptes.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Maj Decompte </font>"); ?>]</a></td>
	</tr>		
	<? }?>
	<tr></tr>
	<td style="width:10px"></td>
	...
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="etat_pointage_globale_imp.php" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Etat De Pointage Imp</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
...
<? }?>		
	...
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="porte_feuilles_factures_up.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Indexer Reglements</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<? if($login == "admin" or $login == "najat" or $login == "rakia" or $login == "Radia" or $login == "mghari") {?>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="comptes_vendeurs.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Situation Vendeurs</font>"); ?>]</a></td>
	...
	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
	<td><a href="registres_remises_impayes_douteux.php?type_c=<? echo $v;?>" target="middle_frame">[<?php print("<font size=\"3\" face=\"Comic sans MS\" color=\"#0000FF\">Clients Tires</font>"); ?>]</a></td>
	</tr>	<tr></tr>
	<td style="width:10px"></td><? $v="ventes";?>
...
<? } else {
	...
	if($login <> "stock" ) { ?>
    <table class="table2">
    <form id="form1" name="form1" method="post" action="productions.php" target="middle_frame">
	<tr><td align="center"><input type="submit" id="production" name="production" value="FICHES DE PRODUCTION "  style="font-size:18px"></td></tr>
	</form>
	<form id="form2" name="form1" method="post" action="programme_machines.php" target="middle_frame">
	<tr><td align="center"><input type="submit" id="production" name="production" value="PROGRAMME MACHINES "  style="font-size:18px"></td></tr>
	</form>
	</table>
	<?php } else {?>
	<table class="table2">
    <form id="form1" name="form1" method="post" action="registres_vendeurs_controle_sorties.php" target="_Blank">
	<tr><td align="center"><input type="submit" id="production" name="production" value="CONTROLE SORTIES "  style="font-size:28px"></td></tr>
	</form>
	</table>
	<?php } ?>
