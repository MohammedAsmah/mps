<?php
	...
	if(isset($_REQUEST["action_"]) && $profile_id == 1) { 
		...
		if($_REQUEST["action_"] != "delete_user") {
			...
			$frs = $_REQUEST["frs"];$ref = $_REQUEST["ref"];$taux_tva = $_REQUEST["taux_tva"];$ttc = $_REQUEST["ttc"];
		...
		switch($_REQUEST["action_"]) {
			...
			case "insert_new_user":
				...
				$sql  = "INSERT INTO achats_mat ( produit,type, frs,ref,date,date_ins,prix_achat,taux_tva,ttc,qte ) VALUES ( ";
				$sql .= "'" . $produit . "', ";
				$sql .= "'" . $mat . "', ";
				$sql .= "'" . $frs . "', ";
				$sql .= "'" . $ref . "', ";
			...
			$sql .= "date = '" . $date . "', ";$sql .= "taux_tva = '" . $taux_tva . "', ";$sql .= "ttc = '" . $ttc . "', ";
			$sql .= "prix_achat = '" . $prix . "' ";
	...
	?>
	<form id="form" name="form" method="post" action="achats_divers.php">
...
<span style="font-size:24px"><?php echo "Achats Divers"; ?></span>
