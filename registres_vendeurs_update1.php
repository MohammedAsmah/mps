<?php
	...
	<form id="form" name="form" method="post" action="registres_vendeurs_update1.php">
...
while($user_ = fetch_array($users11)) { 
	...
	<? $sql  = "SELECT * ";
	$sql .= "FROM commandes_2009 where id_registre=$ancien_registre ORDER BY date_e;";
	...
	while($users_ = fetch_array($users)) { 
		...
		$eval=$users_["eval"];$mois=$users_["mois"];$annee=$users_["annee"];
