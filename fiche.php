<?php
	...
	if($user_id == "0") {
		...
		$produit = "";$favoris = 0;$non_favoris = 0;$colorant="";$qte_colorant=0;$dispo=0;$palmares1=0;
		...
		$accessoire_4="";$qte_ac_4="";$accessoire_5="";$qte_ac_5="";$accessoire_6="";$qte_ac_6="";$date_dispo="";
		$acc1=0;$acc2=0;$acc3=0;$acc4=0;$acc5=0;$acc6=0;$dispo_g=0;
		...
		$non_disponible=$user_["non_disponible"];$seuil_critique=$user_["seuil_critique"];$prix_rechange=$user_["prix_rechange"];$palmares1=$user_["palmares1"];
		...
		$stock_comptable=$user_["stock_comptable"];$prix2 = $user_["prix2"];
		...
		$r1=$user_["r1"];$r2=$user_["r2"];$r3=$user_["r3"];$avec_remise=$user_["avec_remise"];$dispo_g=$user_["dispo_g"];	
...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression de ce produit ?"; ?>")) {
			document.location = "fiches.php?action_=delete_user&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<form id="form_user" name="form_user" method="post" action="fiches.php">
