...
$sql = "SELECT * FROM rs_data_users WHERE user_id = " . $_COOKIE["bookings_user_id"] . ";";
	...
	$sql .= "FROM produits where famille='$article' and dispo=1 and produit<>'$vide' ORDER BY produit;";
...
<form id="regForm" name="regForm" method="post" action="palmares_articles_simulations.php">
	...
	<tr><td><input type="submit" name="Submit1" value="Recherche">
          </td></tr>
...
<? }?>
      <tr><td><input type="submit" name="Submit1" value="Recherche">
		  ...
		  <td><input type="submit" name="Submit2" value="Selectionner">
          </td>
