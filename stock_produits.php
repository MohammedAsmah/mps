<?php
	...
	<form id="form" name="form" method="post" action="stock_produits.php">
...
?>
			...
			$du="2024-10-07";$au=dateFrToUs(date("d/m/y"));
			$sql1  = "SELECT produit,date,sum(depot_a) As total_depot_a,sum(depot_b) As total_depot_b,sum(depot_c) As total_depot_c ";
...
<td bgcolor="#66CCCC"><?php $stock_mps=$e_depot_a-$s_depot_a;$vide=0; echo $vide;?></td>
<td bgcolor="#66CCCC"><?php $stock_jp=$e_depot_b-$s_depot_b; echo $stock_jp+$stock_mps;?></td>
