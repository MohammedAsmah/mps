<?php
	...
	//regroupement menu
	if(isset($_REQUEST["action_2"]) && $profile_id == 1) { 
	...
	<form id="form" name="form" method="post" action="edition_factures_pro.php">
	...
	*/?>
	...
	{
	 /*$du=dateFrToUs($_POST['du']);$au=dateFrToUs($_POST['au']);*/$mois=$_POST['mois'];
...
<? if ($users_["valide"]==1){?>
<? $facture=$users_["id"];$client=$users_["client"];$m=$users_["montant"];$user_id=$users_["id"];
echo "<td><a href=\"maj_factures_pro.php?mois=$mois&montant=$m&numero=$facture&client=$client\">$facture</a></td>";?>
<? echo "<td align=\"right\" bgcolor=\"#FFFF00\"><a href=\"facture11_pro.php?user_id=$user_id&client=$client&facture=$facture&du=$du&au=$au\">$facture</a></td>";?>
...
print("<font size=\"1\" face=\"Comic sans MS\" color=\"000033\">$m </font>");
 ?></td>
<? echo "<td><a href=\"edition_facture_pro.php?numero=$facture&client=$client&date=$date\">Imprimer</a></td>";?>
