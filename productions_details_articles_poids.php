<?php
	...
	$sql .= "FROM details_productions where produit='$produit' and (poids_1<>0 or poids_2<>0 or poids_3<>0) group by id ORDER BY date DESC;";
...
<title><?php echo "" . "Historique poids Production $produit "; ?></title>
...
<span style="font-size:24px"><?php echo "Historique Poids Production $produit "; ?></span>
...
<td style="text-align:center"><?php print("<font size=\"1\" face=\"Comic sans MS\" color=\"000033\">$machine </font>"); ?></td>
