<?php
	...
	if(isset($_REQUEST["action_"]) ) { 
		...
		if($produit <> "") {
				...
				$sql  = "INSERT INTO entrees_stock ( produit, date,date_ins,depot_a,type,depot_b ) VALUES ( ";
				$sql .= "'" . $produit . "', ";
				$sql .= "'" . $date . "', ";
				$sql .= "'" . $date_ins . "', ";
				$sql .= "'" . $depot_a . "', ";
...
--></script>
	...
	<form id="form_user" name="form_user" method="post" action="entrees_stock_barcode_mps_g.php">
	
	<div>
	<h1 style="color:blue;"><?php echo $date_ins." ---->PRODUCTION G vers MPS"; ?></h1>
