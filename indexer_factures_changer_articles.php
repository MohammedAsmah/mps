...
/// update evaluations
	...
	$profiles_list_produit2="";
	$sql1 = "SELECT * FROM produits ORDER BY produit;";
	$temp = db_query($database_name, $sql1);
	while($temp_ = fetch_array($temp)) {
		if($produit2 == $temp_["produit"]) { $selected = " selected"; } else { $selected = ""; }
		
		$profiles_list_produit2 .= "<OPTION VALUE=\"" . $temp_["produit"] . "\"" . $selected . ">";
		$profiles_list_produit2 .= $temp_["produit"];
		$profiles_list_produit2 .= "</OPTION>";
	}
	
	?>
	
	<form id="form" name="form" method="post" action="indexer_factures_changer_articles.php">
	...
	<td><?php echo "Article 1: "; ?></td><td><select id="produit" name="produit"><?php echo $profiles_list_produit; ?></select></td>
	<td><?php echo "Article 2: "; ?></td><td><select id="produit2" name="produit2"><?php echo $profiles_list_produit2; ?></select></td>
	<td><?php $coef=1;echo "Coefficient : "; ?><input type="text" id="coef" name="coef" value="<?php echo $coef; ?>" size="15"></td>
	<tr>
	...
	{
	 $du=dateFrToUs($_POST['du']);$au=dateFrToUs($_POST['au']);$produit_c=$_POST['produit'];$produit_a=$_POST['produit2'];$coef=$_POST['coef'];
	 
	$sql  = "SELECT * ";
	$sql .= "FROM factures2024 where date_f between '$du' and '$au' and editee=0 ORDER BY id;";
...
$remise10 = $users_["remise_10"];$remise2 = $users_["remise_2"];
		$evaluation = $users_["evaluation"];$sans_remise = $users_["sans_remise"];$remise3 = $users_["remise_3"];

	$sql1  = "SELECT * ";$f1=$users_["id"];$vide="0000-00-00";$qte=1;
	$sql1 .= "FROM detail_factures2024 where produit='$produit_c' and editee=0 and facture='$f' ORDER BY produit;";
	...
	//1ER DU 01/01/2022 AU 31/05/2022
	$quantite1=$quantite;
	$condit1=$condit;
	$prix_unit1=$prix_unit;
	
	$sql = "UPDATE detail_factures2024 SET ";
	$sql .= "produit = '" . $produit_a . "', ";$sql .= "quantite = '" . $quantite1 . "', ";
	$sql .= "condit = '" . $condit1 . "', ";
	$sql .= "prix_unit = '" . $prix_unit1 . "' ";
	$sql .= "WHERE id = " . $id1 . ";";
	db_query($database_name, $sql);
	...
	$condit1=1;
	$prix_unit1=90;
	$produit_cc1="MEUBLE DACIA 3 TIROIRS";
	$sql = "UPDATE detail_factures2022 SET ";
	$sql .= "produit = '" . $produit_cc1 . "', ";$sql .= "quantite = '" . $quantite1 . "', ";
	$sql .= "condit = '" . $condit1 . "', ";
	$sql .= "prix_unit = '" . $prix_unit1 . "' ";
	$sql .= "WHERE id = " . $id1 . ";";
	db_query($database_name, $sql);
	...
	$condit1=1;
	$prix_unit1=180;
	$produit_cc1="MEUBLE NAKHLA 2 TIROIRS";
	$sql = "UPDATE detail_factures2022 SET ";
	$sql .= "produit = '" . $produit_cc1 . "', ";$sql .= "quantite = '" . $quantite1 . "', ";
	$sql .= "condit = '" . $condit1 . "', ";
	$sql .= "prix_unit = '" . $prix_unit1 . "' ";
	...
	$condit1=1;
	$prix_unit1=240;
	$produit_cc1="MEUBLE NAKHLA M AJOURE 5T 2C";
	$sql = "UPDATE detail_factures2022 SET ";
	$sql .= "produit = '" . $produit_cc1 . "', ";$sql .= "quantite = '" . $quantite1 . "', ";
	$sql .= "condit = '" . $condit1 . "', ";
	$sql .= "prix_unit = '" . $prix_unit1 . "' ";
...
/*/1ER DU 01/09/2022 AU 31/10/2022
	$quantite1=20;
	$condit1=4;
	$prix_unit1=82;
	$produit_cc1="ARMOIRE PHARMACIE";
	$sql = "UPDATE detail_factures2022 SET ";
	$sql .= "produit = '" . $produit_cc1 . "', ";$sql .= "quantite = '" . $quantite1 . "', ";
	$sql .= "condit = '" . $condit1 . "', ";
	$sql .= "prix_unit = '" . $prix_unit1 . "' ";
	...
	$condit1=4;
	$prix_unit1=41;
	$produit_cc1="MEUBLE MINI T 5TIROIRS";
	$sql = "UPDATE detail_factures2022 SET ";
	$sql .= "produit = '" . $produit_cc1 . "', ";$sql .= "quantite = '" . $quantite1 . "', ";
	$sql .= "condit = '" . $condit1 . "', ";
	$sql .= "prix_unit = '" . $prix_unit1 . "' ";
