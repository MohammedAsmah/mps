...
<body style="background:#dfe8ff">
	...
	?>
	<form id="form" name="form" method="post" action="palmares_gratuites.php">
	...
	$sql  = "SELECT id,commande,client,vendeur,date,sum(net) As total ";
	$sql .= "FROM commandes_gratuites where date_e between '$date' and '$date1' GROUP BY client order by client;";
...
<span style="font-size:24px"><?php echo "Historique Gratuites $du au $au"; ?></span>
...
<? $client=$users_["client"];$bs= "<td><a href=\"detail_panier_gratuite.php?client=$client&du=$date&au=$date1\">$client</a>";
