...
<?php
    ...
    $sql  = "SELECT id,client,vendeur,secteur,date_e,sum(net) As total_net ";$encours="encours";$vide="";
	$sql .= "FROM commandes where secteur='$secteur' and week(NOW()) = week(date_e) and year(NOW()) = year(date_e) and evaluation<>'$encours' and evaluation<>'$vide' GROUP BY client order by total_net DESC;";
