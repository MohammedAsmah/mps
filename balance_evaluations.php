...
<body style="background:#dfe8ff">
	...
	?>
	<form id="form" name="form" method="post" action="balance_evaluations.php">
	...
	$sql .= "FROM commandes where date_e between '$date' and '$date1' and evaluation<>'$encours' and id_registre<>0 and escompte_exercice=0 GROUP BY vendeur;";
...
<tr><? echo "<td><a href=\"\\mps\\examples\\pie_facturations_vendeurs.php?date1=$date&date2=$date1\">Representation Graphique C.A Factures</a></td>";?>
