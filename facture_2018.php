<?php
	...
	if($user_id == "0") {
		...
		$ev1_07="";$ev2_07="";$ev3_07="";$ev4_07="";$ev5_07="";$ev6_07="";$ev7_07="";$ev8_07="";$ev9_07="";$ev10_07 = "";
				$result = mysql_query("SELECT numero,client,date_f FROM factures2018 ORDER BY numero DESC LIMIT 0,1"); 
		...
		if ($d>="2018-01-01"){
		$sql  = "SELECT * ";
		$sql .= "FROM factures2018 WHERE id = " . $_REQUEST["user_id"] . ";";
		}
		else{
		$sql  = "SELECT * ";
...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression ?"; ?>")) {
			document.location = "factures_2018.php?action_=delete_user&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<form id="form_user" name="form_user" method="post" action="factures_2018.php">
