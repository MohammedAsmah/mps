...
//gets the login
	...
	if ($_REQUEST["action_r"]=="reglement"){
		...
		$facture=$_REQUEST["facture_n"];$montant_f=0;$encaiss=$_REQUEST["encaiss"];$reliquat=$_REQUEST["reliquat"];
		
		//////////////////////////////////////////////////////
		//mise ç jour situation vendeurs
		/*if(isset($_REQUEST["encaiss"])) { $encaiss = 1; } else { $encaiss = 0; }
		if ($encaiss){
