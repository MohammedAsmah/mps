...
<? $client=$users_["client"];$commande=$users_["commande"];$evaluation=$users_["evaluation"];$net_e=$users_["net"];
...
<? echo "<a href=\"editer_evaluation_vendeur_ent_escompte.php?destination=$destination&numero=$commande&client=$client&bon_sortie=$bon_sortie\">--ESCOMPTE  </a>";?>
<? echo "<a href=\"editer_evaluation_vendeur_ent1.php?destination=$destination&numero=$commande&client=$client&bon_sortie=$bon_sortie\">--etat3 </a></td>";} else {?>
<td><? $message="N° evaluation à completer avant impression !!";print("<font size=\"1\" face=\"Arial\" color=\"#3366FF\">$message </font>");?></td>
<? } ?>
...
<? if ($valide==0){echo "<td><a href=\"evaluation_vers_vendeur1_escompte.php?commande=$commande&id_registre=$id_registre&date=$date3&vendeur=$vendeur\">devalider</a></td>";}else
