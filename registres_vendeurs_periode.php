...
//promotion
	...
	<form id="form" name="form" method="post" action="registres_vendeurs_periode.php">
...
<? 	if(isset($_REQUEST["action"]))
	...
	$sql .= "FROM registre_vendeurs where date between '$date' and '$date2' ORDER BY date,id;";
	//	$sql .= "FROM registre_vendeurs where date between '$d1' and '$d2' ORDER BY id;";
	$users11 = db_query($database_name, $sql);
?>


<span style="font-size:24px"><?php echo "SITUATION DES VENTES DU ".dateUsToFr($date)." AU ".dateUsToFr($date2); ?></span>
