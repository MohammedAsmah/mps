<?php
	...
	<form id="form" name="form" method="post" action="encaissements_global.php">
...
<? 	if(isset($_REQUEST["action"]))
	...
	$sql .= "FROM porte_feuilles where vendeur='$vendeur' and (date_enc between '$date' and '$date2') Group BY id order by date_enc;";
...
<tr>
	...
	<th><?php echo "Espece/F";?></th>
	<th><?php echo "Espece/E";?></th>
...
$vendeur=$users_1["vendeur"];$impaye=$users_1["impaye"];
		...
		if ($facture_n<>0){
	$sql  = "SELECT * ";$total_espece_f=$users_1["total_espece"];$total_espece_e=0;
	$total_espece_tf=$total_espece_tf+$total_espece_f;
	...
	$date_ff=$user_r3["date_f"];$evaluation=$user_r3["evaluation"];$reference="F/".$facture_n;}
		...
		{$sql  = "SELECT * ";$total_espece_e=$users_1["total_espece"];$total_espece_f=0;
		$total_espece_te=$total_espece_te+$total_espece_e;
	$sql .= "FROM commandes where id=$id_commande and vendeur='$vendeur' GROUP BY id;";
	...
	$date_ff=$user_r["date_e"];$evaluation=$user_r["evaluation"];$reference="E/".$evaluation;
			...
			$sql  = "SELECT * ";
	$sql .= "FROM registre_reglements where id=$id_registre_regl GROUP BY id;";
	$users33r = db_query($database_name, $sql);$user_rr3 = fetch_array($users33r);
	$tableau=$user_rr3["bon_sortie"]."/".$user_rr3["mois"]."".$user_rr3["annee"]; 
			...
			<td><?php print("<font size=\"2\" face=\"Comic sans MS\" color=\"#000033\">$tableau </font>"); ?></td>
			...
			<td align="right"><?php $total_espece=number_format($total_espece_f,2,',',' ');print("<font size=\"2\" face=\"Comic sans MS\" color=\"#000033\">$total_espece </font>"); ?></td>
			<td align="right"><?php $total_espece=number_format($total_espece_e,2,',',' ');print("<font size=\"2\" face=\"Comic sans MS\" color=\"#000033\">$total_espece </font>"); ?></td>
			...
			<td><?php $date_r=dateUsToFr($date_remise);print("<font size=\"2\" face=\"Comic sans MS\" color=\"#000033\">$date_r </font>"); ?></td></tr>
...
<td></td><td></td><td></td><td></td><td></td>
			...
			<td align="right"><?php $total_espece_t=number_format($total_espece_te,2,',',' ');print("<font size=\"2\" face=\"Comic sans MS\" color=\"#000033\">$total_espece_t </font>"); ?></td>
