...
<?php
    ...
    $sql  = "SELECT id,client,vendeur,date_e,secteur,sum(net) As total_net,MONTH(date_e) As mois ";$encours="encours";
	$sql .= "FROM commandes where YEAR(date_e) ='$annee' and evaluation<>'$encours' GROUP BY client order by total_net DESC;";
