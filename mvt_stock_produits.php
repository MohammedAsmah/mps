<?php
	...
	<form id="form" name="form" method="post" action="mvt_stock_produits.php">
...
$sql1 = "UPDATE produits SET stock_simulation = $stock_simulation,date_simulation='$au',stock_mps=$stock_mps,stock_jp=$stock_jp WHERE produit='$produit'";
	db_query($database_name, $sql1);
				...
				$sql = "DELETE FROM mvt_stock_produits WHERE date = " . $date1 . ";";
			db_query($database_name, $sql);
	
	
				$sql  = "INSERT INTO mvt_stock_produits (date,produit,depot_a,depot_b)
				 VALUES ('$date1','$produit','$stock_mps','$stock_jp')";
