...
if(isset($_SESSION["id"] )) {
    ...
    if(isset($_GET["idmachine"])){
        $machine = $MachineS->findbyid($_GET['idmachine']);
    }
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($image)){
            if ($MachineS->updatemachine($_GET['idmachine'],$ref,$nom,$image)) {
                header('location: index.php?update=ok');
            }
        }else{
            if($machine[3] == null) {
                if ($MachineS->updatemachine($_GET['idmachine'], $ref, $nom, "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Bonsack_machine.png/1200px-Bonsack_machine.png")) {
                    header('location: index.php?update=ok');
                }
            }else{
                if ($MachineS->updatemachine($_GET['idmachine'], $ref, $nom, $machine[3])) {
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="container">
                    ...
                    <form action="editmachine.php?idmachine=<?php echo $machine[0] ?>" method="post" enctype="multipart/form-data">
                        <div class="preview text-center">
                            <img class="preview-img" src="<?php echo $machine[3] ?>" id="output" alt="Preview Image" width="200" height="200"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ref" value="<?php echo $machine[1] ?>" required placeholder="Entrer Ref machine"/>
                            <span class="Error"></span>
                        </div>
                        <div class="form-group">
                            <label>Nom de la machine :</label>
                            <input class="form-control" type="text" name="nom" value="<?php echo $machine[2] ?>" required placeholder="Entrer Nom machiner"/>
                            <span class="Error"></span>
                        </div>
                        <div class="form-group">
