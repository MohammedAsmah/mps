...
if(isset($_SESSION["id"] )) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($image)) {
            $machine = $machine->construct1($ref, $nom, $image);
            if ($MachineS->add($machine)) {
                header('location: index.php?add=ok');
            }
        }else{
            $machine = $machine->construct1($ref, $nom, "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ce/Bonsack_machine.png/1200px-Bonsack_machine.png");
            if ($MachineS->add($machine)) {
                header('location: index.php?add=ok');
            }
        }
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form action="addmachine.php" method="post" enctype="multipart/form-data">
                        <div class="preview text-center">
                            <img class="preview-img" src="http://simpleicon.com/wp-content/uploads/loader.png" id="output" alt="Preview Image" width="200" height="200"/>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="ref" required placeholder="Entrer Ref machine"/>
                            <span class="Error"></span>
                        </div>
                        <div class="form-group">
                            <label>Nom de la machine :</label>
                            <input class="form-control" type="text" name="nom" required placeholder="Entrer Nom machiner"/>
                            <span class="Error"></span>
                        </div>
                        <div class="form-group">
