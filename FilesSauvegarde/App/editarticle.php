...
if(isset($_SESSION["id"] )) {
    ...
    if(isset($_GET["ida"])){
        $article = $MachineS->findarticlebyid($_GET["ida"]);
    }
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if(isset($image)){
            if ($MachineS->updatearticle($_GET['ida'],$nom,$image)) {
                header('location: listearticle.php?update=ok');
            }
        }else{
            if($MachineS->updatearticle($_GET['ida'],$nom,"http://www.intl-spectrum.com/articles/r209/ArticleDefault.jpg?x=80x56")){
                header('location: listearticle.php?update=ok');
            }
        }
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form action="editarticle.php?ida=<?php echo $article[0] ?>" method="post"  enctype="multipart/form-data">
                        <div class="preview text-center">
                            <img class="preview-img" src="<?php echo $article[2] ?>" id="output" alt="Preview Image" width="200" height="200"/>
                        ...
                        <div class="preview text-center">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="<?php echo $article[1] ?>" name="nom" required placeholder="Entrer Nom d'article"/>
                                <span class="Error"></span>
                            </div>
                            <div class="form-group">
