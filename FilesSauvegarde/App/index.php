...
if(isset($_SESSION["id"] )) {
    ...
    if (!isset($_GET["like"]) || $_GET["like"] == null) {
        ...
        $nbrproduit = $MachineS->findcountproduit();
        ...
        $nbrproduit = (int)$MachineS->findcountproduit();
        $parPage = 100;
        $pages = ceil($nbrproduit / $parPage);
        $premier = ($currentPage * $parPage) - $parPage;
        $produit1 = $machines;
        $produit = $MachineS->findallproduitpagination($premier, $parPage);
    } else {

        $produit = $MachineS->findbyidwherenomlike(strtolower('%' . $_GET["like"] . '%'));
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="headingone" class="collapse show" aria-labelledby="headingone" data-parent="#accordionSidebar">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Nombre de fichier (Scanner)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $MachineS->selectcountscann() ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Nombre machine </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $MachineS->findcountproduit() ?></div>
                                        </div>
                                        <div class="col-auto">
                ...
                <div id="main-content" class="file_manager">
                    ...
                    <div class="container">
                        <div class="row clearfix">
                            ...
                            <?php if(isset($produit)){ foreach ($produit as $item){ ?>
                                <div class="col-lg-3 col-md-4 col-sm-12">
                                    <div class="card" style="background-color: lightgrey">
                                        <div class="file">
                                            <div align="center" >
                                                <br>
                                                <a href="searchforfile.php?id=<?php echo $item["id"] ?>">  <button type="button" onclick="window.location.href('machine.php');" class="btn btn-default btn-circle">
                                                        <i class="fas fa-plus"></i>
                                                    </button></a>
                                                <a href="editmachine.php?idmachine=<?php echo $item["id"] ?>">   <button type="button" class="btn btn-info btn-circle">
                                                        <i class="fas fa-edit"></i>
                                                    </button></a>
                                                
												<? /* ?> <a href="delete.php?id=<?php echo $item["id"] ?>">   <button type="button" class="btn btn-danger btn-circle">
                                            ...
                                            <div class="icon">
                                                <img src="<?php echo $item["image"] ?>" height="80px" width="100%">
                                            </div>
                                            <div class="file-name">
                                                <p class="m-b-5 text-muted" style="color: black" align="center"><b><?php echo $item["Nom_Machine"] ?></b></p>
                                                <small>Ref : <?php echo $item["Ref_Machine"] ?> <span class="date text-muted"><?php echo "Nbre Files :". $MachineS->findcountmachinearitcle($item["id"]) ?></span></small>
                                            </div>
                            ...
                            <ul class="pagination-box">
                                ...
                                <nav>
                                    <ul class="pagination">
                                        ...
                                        if($currentPage > 6 ){ ?>
                                            <li class="page-item">
                                                <a href="index.php?page=<?= $currentPage - 3 ?>" class="page-link" class="page-link">..</a>
                                            </li>
                                            <?php
                                        }
