...
<?php
	...
	$sql .= "FROM detail_commandes where produit='$produit' and MONTH(date) ='$mois' and YEAR(date) ='$annee' and escompte_exercice=0 GROUP BY produit,client order by total_quantite DESC;";
