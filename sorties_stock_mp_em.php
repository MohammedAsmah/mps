<?php
	...
	?>
	<form id="form" name="form" method="post" action="sorties_stock_mp_em.php">
	...
	$sql  = "SELECT * ";$type="sortie";$date=dateFrToUs($_POST['date']);$mp3="EMBALLAGES ET CONSOMMABLES";
	$sql .= "FROM entrees_stock_mp where date='$date' and type='$type' and famille='$mp3' ORDER BY date;";
	$users = db_query($database_name, $sql);}
	else
	{	$sql  = "SELECT * ";$type="sortie";$dj=date("Y-m-d");$mp3="EMBALLAGES ET CONSOMMABLES";
...
<script type="text/javascript"><!--
	function EditUser(user_id) { document.location = "sortie_stock_mp_em.php?user_id=" + user_id; }
--></script>
...
<table><tr><td>
<? if ($date<>""){echo "<a href=\"sortie_stock_mp_em.php?date=$date&user_id=0\">Ajout SORTIE</a></td>";}?></tr><tr>
