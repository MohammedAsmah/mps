...
<?			
	...
	?>
	<form id="form" name="form" method="post" action="balance_banques.php">
	...
	$sql .= "FROM journal_banques where date between '$date' and '$date1' GROUP BY caisse;";
...
<span style="font-size:24px"><?php echo "Balance Banque Du $du Au $au"; ?></span>
...
<? echo "<td><a href=\"balance_banques_types.php?caisse=$caisse&date=$date&date1=$date1\">$caisse</a></td>";?>
