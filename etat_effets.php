<?php
	...
	<form id="form" name="form" method="post" action="etat_effets.php">
...
<? 	 $date=date("Y-m-d");$total=0;
	...
	$sql .= "FROM porte_feuilles where m_effet<>0 and remise_e=0 and (date_enc between '$date' and '$date2') group by id ORDER BY date_enc;";
	$users11 = db_query($database_name, $sql);
