...
<body style="background:#dfe8ff">
	...
	?>
	<form id="form" name="form" method="post" action="palmares_secteurs.php">
	...
	$sql  = "SELECT ville,trimestre,commande,client,vendeur,date,sum(net) As total ";
...
<span style="font-size:24px"><?php echo "Palmares Secteurs $du au $au"; ?></span>
...
?><tr>
<?php $vendeur=$users_["vendeur"];$ville=$users_["ville"];?>
<? echo "<td><a href=\"palmares_details_vendeurs.php?vendeur=$vendeur&ville=$ville&date=$date&date1=$date1\">$ville</a></td>";?>
