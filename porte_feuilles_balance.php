...
<? 	
	...
	$sql .= "FROM porte_feuilles where date_cheque>='$date' and m_cheque<>0 and remise=0 GROUP BY date_cheque;";
...
while($users_1 = fetch_array($users11)) { 
			...
			<? echo "<tr><td><a href=\"porte_feuilles_details.php?date_cheque=$date_cheque1\">$date_cheque</a></td>";?>
			<td align="right"><?php $total_g=$total_g+$total_cheque;echo number_format($total_cheque,2,',',' '); ?></td></tr>


<? } ?>
<tr><td></td><td align="right"><?php echo number_format($total_g,2,',',' '); ?></td>
</table>
</strong>
