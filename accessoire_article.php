<?php
	...
	if($user_id == "0") {
		...
		$accessoire_3=$user_["accessoire_3"];$qte_ac_3=$user_["qte_ac_3"];$equipes=$user_["equipes"];$date_dispo=dateUsToFr($user_["date_dispo"]);
...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression de ce produit ?"; ?>")) {
			document.location = "accessoires_articles.php?action_=delete_user&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<form id="form_user" name="form_user" method="post" action="accessoires_articles.php">
