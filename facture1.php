...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression ?"; ?>")) {
			document.location = "factures_instances.php?action_=delete_user&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<form id="form_user" name="form_user" method="post" action="factures_instances.php">
...
<input type="hidden" id="du" name="du" value="<?php echo dateUsToFr($du); ?>">
<input type="hidden" id="au" name="au" value="<?php echo dateUsToFr($au); ?>">
