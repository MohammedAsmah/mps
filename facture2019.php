<?php
	...
	if($user_id == "0") {
		...
		$vendeur = $user_["vendeur"];$montant = $user_["montant"];$id = $user_["id"];$numero_avoir = $user_["numero_avoir"];$date_avoir = dateUsToFr($user_["date_avoir"]);$montant_avoir = $user_["montant_avoir"];
		$nature_avoir = $user_["nature_avoir"];
...
<form id="form_user" name="form_user" method="post" action="factures2019.php">
	...
	<table class="table3">
		...
		<br/><br/><br/><br/>
		<tr>
		<td><?php echo "Date Avoir"; ?></td><td><input onClick="ds_sh(this);" name="date_avoir" value="<?php echo $date_avoir; ?>" readonly="readonly" style="cursor: text" /></td>
		</tr>
		<tr><td><?php echo "Numero Avoir "; ?></td><td><input type="text" id="numero_avoir" name="numero_avoir" style="width:60px" value="<?php echo $numero_avoir; ?>"></td>
		</tr>
		<tr><td><?php echo "Montant Avoir "; ?></td><td><input type="text" id="montant_avoir" name="montant_avoir" style="width:60px" value="<?php echo $montant_avoir; ?>"></td>
		</tr>
		<tr><td><?php echo "Nature Avoir "; ?></td><td><input type="text" id="nature_avoir" name="nature_avoir" style="width:260px" value="<?php echo $nature_avoir; ?>"></td>
		</tr>
		<? }?>
		</tr>
