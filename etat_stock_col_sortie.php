<?php
	...
	<form id="form" name="form" method="post" action="etat_stock_col_sortie.php">
	<td>
	...
	$sql  = "SELECT * ";$t1="mp";$mr="COLORANTS";$mp="MATIERE P";
	$sql .= "FROM matieres_premieres where type='$mr' ORDER BY produit;";
