...
$pdf->SetFont('Arial','B',14);
	...
	//BL
	if ($dt>="2015-01-01" and $dt<="2015-12-31"){$att="ATTESTATION D'EXONORATION N°24/15 DU 28/01/2015 ";}
	if ($dt>="2016-01-01" and $dt<="2016-12-31"){$att="ATTESTATION D'EXONORATION N°23/16 DU 02/02/2016 ";}
