...
set_time_limit($valeur);
	...
	<form id="form" name="form" method="post" action="releves_factures_com.php">
...
<table><tr><? echo "<td><a href=\"\\mps\\tutorial\\releve_factures_com.php?date1=$date_d1&date2=$date_d2\">Imprimer Facturation du mois</a></td>";?>
<tr></tr>
...
<tr><? echo "<td><a href=\"\\mps\\tutorial\\edition_factures.php?date1=$date_d1&date2=$date_d2\">Imprimer Factures</a></td>";?>
</table>
</tr>
<? } ?>
