...
while (!feof($fp))
{
  ...
  $liste[6] = ( isset($liste[6]) ) ? $liste[6] : Null;
	...
	if ($champs1!='')
		...
		$query = "INSERT INTO detail_commandes (id,champs1,commande,produit,prix_unit,quantite,condit,remise,remise1)
		VALUES('','$champs_v','$champs0','$champs1','$champs2','$champs3','$champs4','$champs5','$champs6')";  
