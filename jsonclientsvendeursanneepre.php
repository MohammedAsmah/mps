...
<?php
    ...
    $sql  = "SELECT id,client,vendeur,date_e,sum(net) As total_net,MONTH(date_e) As mois ";$encours="encours";
	...
	$sql .= "FROM commandes where YEAR(date_e) ='$annee' and vendeur='$vendeur' and evaluation<>'$encours' GROUP BY client order by total_net DESC;";
