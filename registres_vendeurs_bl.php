...
//promotion
	...
	<form id="form" name="form" method="post" action="registres_vendeurs_bl.php">
...
<? 	if(isset($_REQUEST["action"]))
	...
	$sql .= "FROM registre_vendeurs where date between '$date' and '$date2' and bl_in=0 and bl_out=1 ORDER BY date,id;";
