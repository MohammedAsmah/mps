...
while($users_1 = fetch_array($users11)) { 
			...
			<? echo "<tr><td><a href=\"porte_feuilles_effet_details1.php?date_cheque=$date_cheque1\">$date_cheque</a></td>";?>
...
<tr><? echo "<td><a href=\"\\mps\\tutorial\\porte_feuilles_effets.php\">Imprimer</a></td>";?>
<tr><? echo "<td><a href=\"\\mps\\tutorial\\porte_feuilles_effets_details.php\">Imprimer detail</a></td>";?>
