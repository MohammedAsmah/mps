...
/// update evaluations
	...
	<form id="form" name="form" method="post" action="factures_update.php">
	...
	<? $du = "2011-01-01";$au = "2013-12-31";
	if(isset($_REQUEST["action"]))
	{
	 $du=dateFrToUs($_POST['du']);$au=dateFrToUs($_POST['au']);
	$sql  = "SELECT * ";
	$sql .= "FROM factures where numero<13000 and date_f between '$du' and '$au' ORDER BY id;";
