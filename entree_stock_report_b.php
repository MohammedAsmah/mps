<?php
	...
	if($user_id == "0") {
		...
		$depot_a = $user_["depot_b"];$depot_b = $user_["depot_a"];$depot_c = $user_["depot_c"];
...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression de ce produit ?"; ?>")) {
			document.location = "entrees_stock_report_b.php?action_=delete_user&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<form id="form_user" name="form_user" method="post" action="entrees_stock_report_b.php">
