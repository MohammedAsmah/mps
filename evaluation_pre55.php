...
$pdf->Cell(80,14,'   Evaluation Vendeur M.P.S',1,0,'L',1);
...
$pdf->SetY(30);$pdf->SetX(5);$d="Client : ".$c;
$pdf->Cell(40,10,$d,0,0,'L',1);

$pdf->SetY(35);$pdf->SetX(95);$d="Numero :  ".$bon_sortie;
...
$ligne=65;$pdf->Line(3,60,3,65);$pdf->Line(205,60,205,65);
	...
	while($users1_ = fetch_array($users1)) { 
		...
		if ($qte>0){$pdf->SetY($ligne);$pdf->SetX(10);
	...
	$pdf->Line(205,$ligne,205,$ligne+5);
		...
		if ($ligne>=220){$pdf->Line(3,$ligne+5,205,$ligne+5);
