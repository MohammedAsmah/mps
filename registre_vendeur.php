...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression ?"; ?>")) {
			document.location = "registres_vendeurs.php?action_=delete_user&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<form id="form_user" name="form_user" method="post" action="registres_vendeurs.php">
...
<table class="table2"><tr><td style="text-align:center">
		...
		*/ ?>
		...
		<tr>
		<td><input type="checkbox" id="bl_in" name="bl_in"<?php if($bl_in) { echo " checked"; } ?>></td>
		<td><?php echo "BL RETOURNE"; ?></td></tr>
