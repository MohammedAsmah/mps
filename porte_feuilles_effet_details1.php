...
<? 	
	...
	$sql .= "FROM porte_feuilles where date_echeance='$date' and m_effet<>0 and remise_e=0 and eff_f=1 GROUP BY numero_effet;";
	$users11 = db_query($database_name, $sql);
	
?>


<span style="font-size:24px"><?php echo "Porte Feuilles Facturé au : ".dateUsToFr($date); ?></span>
