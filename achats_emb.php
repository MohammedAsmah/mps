<?php
	...
	if(isset($_REQUEST["action_"]) && $profile_id == 1) { 
		...
		switch($_REQUEST["action_"]) {
			...
			case "insert_new_user":
				...
				$d=dateFrToUs(date("d/m/Y"));$emb="emb";
	...
	?>
	<form id="form" name="form" method="post" action="achats_emb.php">
...
<script type="text/javascript"><!--
	function EditUser(user_id) { document.location = "achat_emb.php?user_id=" + user_id; }
--></script>
...
<span style="font-size:24px"><?php echo "Achats Emballages"; ?></span>
