<?php
	...
	<form id="form" name="form" method="post" action="stock_produits_global.php">
...
<? $sql  = "SELECT * ";$vide="";$article="article";$variante="MEUBLE NAKHLA";
	$sql .= "FROM produits where dispo=1 and produit<>'$vide' and stockable=1 and fictif=0 ORDER BY produit;";
...
<td bgcolor="#66CCCC"><?php $stock_mps=$stock_mps+$e_depot_a-$s_depot_a; echo $users_["stock_mps"];?></td>
<td bgcolor="#66CCCC"><?php $stock_jp=$stock_jp+$e_depot_b-$s_depot_b; echo $users_["stock_jp"];?></td>
<td bgcolor="#66CCCC"><?php $stock_simulation=$stock_mps+$stock_jp; echo $users_["stock_simulation"];?></td>
<td bgcolor="#66CCCC"><?php  echo dateUsToFr($users_["date_simulation"]);?></td>
...
/*$sql1 = "UPDATE produits SET stock_simulation = $stock_simulation,date_simulation='$au',stock_mps=$stock_mps,stock_jp=$stock_jp WHERE produit='$produit'";
	db_query($database_name, $sql1);*/
				...
				/*$datemaj="2024-10-07";$type="MAJ STOCK";
				$sql  = "INSERT INTO entrees_stock1 ( produit, date,depot_b,type,depot_a ) VALUES ( ";
				$sql .= "'" . $produit . "', ";
				$sql .= "'" . $datemaj . "', ";
				$sql .= "'" . $stock_jp . "', ";
				$sql .= "'" . $type . "', ";
