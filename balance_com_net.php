...
<body style="background:#dfe8ff">
	...
	?>
	<form id="form" name="form" method="post" action="balance_com_net.php">
...
<?php 
	...
	$sql .= "FROM porte_feuilles where (date_enc between '$date' and '$date1')  and (date_e between '$date' and '$date1') Group BY vendeur;";
