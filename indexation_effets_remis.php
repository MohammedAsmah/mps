<?php
	...
	<form id="form" name="form" method="post" action="indexation_effets_remis.php">
...
<? 	 $date=date("Y-m-d");$total=0;
	...
	$sql  = "SELECT * ";
	$sql .= "FROM porte_feuilles_factures where m_effet<>0 and (date_echeance between '$date' and '$date2') and (date_remise_e > '$date2') and remise_e=1 ORDER BY date_echeance;";
	$users11 = db_query($database_name, $sql);
