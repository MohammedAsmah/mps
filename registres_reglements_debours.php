<?php
	...
	// recherche contrat			
				...
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet1','$impaye','$date_open','$id_registre','$e_e','$date_cheque1','$cheque1','$ref1')";
				db_query($database_name, $sql1);}
				if ($objet2<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet2','$impaye','$date_open','$id_registre','$e_e','$date_cheque2','$cheque2','$ref2')";
				db_query($database_name, $sql1);}
				if ($objet3<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet3','$impaye','$date_open','$id_registre','$e_e','$date_cheque3','$cheque3','$ref3')";
				db_query($database_name, $sql1);}
				if ($objet4<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet4','$impaye','$date_open','$id_registre','$e_e','$date_cheque4','$cheque4','$ref4')";
				db_query($database_name, $sql1);}
				if ($objet5<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet5','$impaye','$date_open','$id_registre','$e_e','$date_cheque5','$cheque5','$ref5')";
				db_query($database_name, $sql1);}
				if ($objet6<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet6','$impaye','$date_open','$id_registre','$e_e','$date_cheque6','$cheque6','$ref6')";
				db_query($database_name, $sql1);}
				if ($objet7<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet7','$impaye','$date_open','$id_registre','$e_e','$date_cheque7','$cheque7','$ref7')";
				db_query($database_name, $sql1);}
				if ($objet8<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet8','$impaye','$date_open','$id_registre','$e_e','$date_cheque8','$cheque8','$ref8')";
				db_query($database_name, $sql1);}
				if ($objet9<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet9','$impaye','$date_open','$id_registre','$e_e','$date_cheque9','$cheque9','$ref9')";
				db_query($database_name, $sql1);}
				if ($objet10<>""){
				$sql1  = "INSERT INTO porte_feuilles 
				(vendeur,impaye,client ,evaluation,date_enc,id_registre_regl,e_e,date_cheque,m_cheque,numero_cheque)
				VALUES ('$vendeur','$impaye','$objet10','$impaye','$date_open','$id_registre','$e_e','$date_cheque10','$cheque10','$ref10')";
				db_query($database_name, $sql1);}
			...
			db_query($database_name, $sql);
				...
				db_query($database_name, $sql);$e_e=1;
	...
	<form id="form" name="form" method="post" action="registres_reglements_debours.php">
...
<?php $compteur1=0;$total_g=0;$total_eval_mois=0;$total_mtr=0;
while($users_1 = fetch_array($users11)) { $id_r=$users_1["id"];$date_enc=$users_1["date"];$vendeur=$users_1["vendeur"];
			...
			<? $user_id=$users_1["id"];$d=dateUsToFr($users_1["date"]);$libelle1=$users_1["libelle1"];$libelle2=$users_1["libelle2"];$libelle3=$users_1["libelle3"];$libelle4=$users_1["libelle4"];$libelle5=$users_1["libelle5"];
			$montant1=$users_1["montant1"];$montant2=$users_1["montant2"];$montant3=$users_1["montant3"];$montant4=$users_1["montant4"];$montant5=$users_1["montant5"];
			$l_tr=$libelle1." ".$libelle2." ".$libelle3." ".$libelle4." ".$libelle5;
			$m_tr=$montant1+$montant2+$montant3+$montant4+$montant5;
			?>
			<? echo "<td>".$d."</td>";?>
			...
			<? 			
			?>
			<? echo "<td>".number_format($m_tr,2,',',' ')."</td>";?>
			<? echo "<td>".$l_tr."</td>";?>
	<? 
	
			 ?><? 
			$total_mtr=$total_mtr+$m_tr;?>
			<? 
			
 } ?>
<tr><td></td><td></td>
<? echo "<td>".number_format($total_mtr,2,',',' ')."</td>";?>
<td></td>
</table>
</strong>
