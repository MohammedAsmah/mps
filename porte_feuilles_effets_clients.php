...
<?php if($error_message != "") { echo $error_message . "<p>"; } ?><p>
	...
	?>
	<form id="form" name="form" method="post" action="porte_feuilles_effets_clients.php">
...
while($users_1 = fetch_array($users11)) { 
			...
			<? echo "<tr><td><a href=\"porte_feuilles_effet_details1c.php?client=$client&date=$date\">$client</a></td>";?>
...
<tr><? echo "<td><a href=\"\\mps\\tutorial\\porte_feuilles_effets_clients.php?date=$date\">Imprimer</a></td>";?>
<tr><? echo "<td><a href=\"\\mps\\tutorial\\porte_feuilles_effets_details_clients.php?date=$date\">Imprimer detail</a></td>";?>
