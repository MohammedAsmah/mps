<?php
	...
	<form id="form" name="form" method="post" action="stock_produits1.php">
...
<? $sql  = "SELECT * ";$vide="";$article="article";$variante="MEUBLE NAKHLA";
	$sql .= "FROM produits where dispo=1 and produit<>'$vide' and stockable=1 and fictif=0 and id<400 ORDER BY produit;";
