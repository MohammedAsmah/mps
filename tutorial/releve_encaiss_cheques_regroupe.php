...
/*$result=mysql_query('select Code,Name,Price from Products ORDER BY Code',$link);*/
		$sql  = "SELECT vendeur,date_virement,date_remise,date_e,date_echeance,date_enc,numero_cheque,facture_n,client,
		...
		Group BY vendeur order by facture_n;";
		/*$ccc="BENYAHIYA HAMID";
