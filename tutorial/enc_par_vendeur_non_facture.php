...
$pdf->Cell(30,8,'Tableau',1,0,'L',1);
$pdf->Cell(70,8,'Bon Sortie',1,0,'L',1);
$pdf->Cell(35,8,'Ref/regl',1,0,'L',1);
...
while($row = fetch_array($users11))
{
	...
	$client = $row['client'];
	$numero_cheque = $row['numero_cheque']."-".$row['v_banque'];
	...
	$pdf->Cell(30,6,$id_tableau,1,0,'L',1);
	$pdf->Cell(70,6,$bon,1,0,'L',1);
	$pdf->Cell(35,6,$numero_cheque,1,0,'L',1);
	$pdf->Cell(25,6,number_format($total_espece,2,',',' '),1,0,'R',1);
	$pdf->Cell(25,6,number_format($total_cheque,2,',',' '),1,0,'R',1);
	$pdf->Cell(25,6,number_format($total_effet,2,',',' '),1,0,'R',1);
	$pdf->Cell(25,6,number_format($total_virement,2,',',' '),1,0,'R',1);
