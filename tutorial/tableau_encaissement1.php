...
$y_axis_initial = 25;$y_axis = 25;$row_height=6;
	...
	$id_r=$users_1["id"];$date=$users_1["date"];$vendeur=$users_1["vendeur"];
...
while($row = fetch_array($users11))
{
	...
	/*$cheque=0;*/
	$pdf->SetX(100);$net_enc=number_format($t_espece-($montant1+$montant2+$montant3+$montant4+$montant5)+$cheque+$t_imp,2,',',' ');
