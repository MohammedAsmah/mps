...
$pdf->SetY(5);$t_show="SITUATION PORTE FEUILLE EFFETS ";$pdf->SetX(60);
...
$pdf->SetX(35);
$pdf->Cell(30,8,'Date Echeance',1,0,'M',1);
$pdf->Cell(40,8,'B C P',1,0,'M',1);
...
/*$result=mysql_query('select Code,Name,Price from Products ORDER BY Code',$link);*/
	...
	$sql .= "FROM porte_feuilles where m_effet<>0 and remise_e=0 and eff_f=1 GROUP BY date_echeance order by date_echeance;";
...
$pdf->Cell(40,8,'Cumul',1,0,'R',1);
	...
	$date_cheque = $row['date_echeance'];$total_cheque=$row['total_cheque'];$total_cheque_t=$total_cheque_t+$total_cheque;
	$pdf->SetY($y_axis);$vide="";
	$pdf->SetX(35);$input="";$date=dateUsToFr($date_cheque);
	$pdf->Cell(30,6,$date,1,0,'L',1);
	$pdf->Cell(40,6,number_format($total_cheque,2,',',' '),1,0,'R',1);
	...
	$pdf->Ln();	
	$pdf->SetX(105);
	$pdf->Cell(40,5,number_format($t,2,',',' '),1,0,'R',1);
$pdf->Output();
?>
