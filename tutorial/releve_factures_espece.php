...
$pdf->SetY(15);$t_show="RELEVE FACTURES ENCAISSES EN ESPECE DU MOIS  : ".dateUsToFr($date1)."   ".dateUsToFr($date2);
$pdf->SetX(40);
$pdf->Cell(200,6,$t_show,1,0,'C',1);
...
$pdf->Cell(30,8,'Timbres 0.25%',1,0,'C',1);
...
/*$result=mysql_query('select Code,Name,Price from Products ORDER BY Code',$link);*/
	...
	if ($date2>"2016-12-31"){
	if ($date2>="2018-01-01"){$factures="factures2018";$exe="/18";}else{$factures="factures";$exe="/17";}
	$sql  = "SELECT * ";
...
$facture=$row["id"]+0;$exercice=$row["exercice"];$facture1=$zero.$facture."/".$exercice;
}else
{
$facture=$row["id"]+9040;
}
	...
	$pdf->Cell(13,6,$facture1,1,0,'L',1);
...
while($row = fetch_array($users11))
{
	...
	$pdf->Cell(30,6,number_format($total_espece*0.25/100,2,',',' '),1,0,'R',1);
	...
	$pdf->Cell(30,5,number_format($t_espece_t*0.25/100,2,',',' '),1,0,'R',1);
...
$pdf->SetY(15);$t_show="COMMISSIONS VENDEURS FACTURATION DU MOIS  : ".dateUsToFr($date1)."   ".dateUsToFr($date2);
$pdf->SetX(80);
