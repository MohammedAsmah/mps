...
$pdf->Cell(60,7,'06H-14H',1,0,'C',1);
$pdf->Cell(60,7,'14H-22H',1,0,'C',1);
$pdf->Cell(60,7,'22H-06H',1,0,'C',1);

$pdf->Cell(16,7,'TOTAL',1,0,'C',1);
...
$tc3= $users_["tc3"];
	...
	$pdf->SetX(5);
	$sql12  = "SELECT * ";
	$sql12 .= "FROM produits where produit='$p' ORDER BY produit;";
	$users122 = db_query($database_name, $sql12);$user_122 = fetch_array($users122);
	
		$famille = $user_122["famille"];	
