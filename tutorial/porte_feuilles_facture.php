...
$pdf->SetX(35);
$pdf->Cell(30,8,'Date Remise',1,0,'M',1);
...
/*$result=mysql_query('select Code,Name,Price from Products ORDER BY Code',$link);*/
	...
	$sql .= "FROM porte_feuilles where m_cheque<>0 and remise=0 and chq_f=1 GROUP BY date_cheque order by date_cheque;";
...
$pdf->Cell(40,8,'Cumul',1,0,'R',1);		
	...
	if ($remise==0){$total_cheque_t=$total_cheque_t+$total_cheque;
