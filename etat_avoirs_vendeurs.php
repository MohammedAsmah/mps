<?php
	...
	?>
	<form id="form" name="form" method="post" action="etat_avoirs_vendeurs.php">
	<table>
	...
	$vendeur=$_POST['vendeur'];$destination=$_POST['destination'];$date_au=$_POST['date2'];$date_du=$_POST['date'];
		...
		{
		$sql  = "SELECT * ";
		$sql .= "FROM avoirs where vendeur='$vendeur' and date_e between '$date' and '$date2' ORDER BY date_e;";
		$users = db_query($database_name, $sql);
		}
		}
