	...
	$sql = "TRUNCATE TABLE `avances_salaires`  ;";
  ...
  $liste[10] = ( isset($liste[10]) ) ? $liste[10] : Null;*/
	...
	if ($champs0!='')
		...
		*/
		...
		$query = "INSERT INTO avances_salaires (id,employe,date,montant,embauche,motif,echeance,montant_echeance,debut)
		VALUES('','$champs0','$date','$champs1','$champs2','$motif','$echeance','$m','$debut')";  
