...
<script type="text/javascript"><!--
	...
	function DeleteUser() {
		if(window.confirm("<?php ; ?>\n<?php echo "Confirmer la suppression de ce produit ?"; ?>")) {
			document.location = "entrees_stock_b_vers_a.php?action_=delete_user&user_id=<?php echo $_REQUEST["user_id"]; ?>";
		}
	}
...
<form id="form_user" name="form_user" method="post" action="entrees_stock_b_vers_a.php">
...
<table class="table2"><tr><td style="text-align:center">
	...
	<table width="671" class="table3">
		...
		<tr>
		<td bgcolor="#33CCCC"><?php echo "Bon de Reception Magasin"; ?></td><td><input type="text" id="bon" name="bon" style="width:140px" value="<?php echo $bon; ?>"></td>
		</tr>
		<tr>
