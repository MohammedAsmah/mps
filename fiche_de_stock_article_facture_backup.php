...
require('fpdf.php');
	...
	$produit = $_REQUEST["p"];$qte_tige1=0;
		...
		$matiere=$user_["matiere"];$qte_matiere=$user_["qte_matiere"];$etiquette=$user_["etiquette"];$qte_etiquette=$user_["qte_etiquette"];
			...
			$ref="Stock initial au 01/01";$date_ini="2017-01-01";$t1=1;
			...
			$sql1  = "SELECT * ";$du="2017-01-01";$au=dateFrToUs("31/12/2017");
			...
			$sql1  = "SELECT * ";$qte_vendu=0;$du="2017-01-01";$au=dateFrToUs("31/12/2017");
...
$pdf->SetFont('arial','',12);	
		...
		$sql1  = "SELECT * ";$du="2017-01-01";$au=dateFrToUs(date("d/m/y"));
