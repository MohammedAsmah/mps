<?php
	...
	$sql  = "SELECT * ";
	$sql .= "FROM rs_data_produits where profile_id=1 ORDER BY last_name;";
	...
	$produit_list = "";
	$sql = "SELECT * FROM  rs_data_produits where profile_id=1 ORDER BY last_name ;";
	$temp = db_query($database_name, $sql);
	while($temp_ = fetch_array($temp)) {
	...
	<form id="form" name="form" method="post" action="etat_arrivees_par_circuit.php">
