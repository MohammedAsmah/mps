<?php
	...
	<form id="form" name="form" method="post" action="etat_effets_encaisses.php">
...
<? 	 $date=date("Y-m-d");$total=0;$date_jour=date("Y-m-d");
	...
	$sql .= "FROM porte_feuilles where facture_n<>0 and m_effet<>0 and id_registre_regl<>0 and remise_e=1 
	and date_echeance>'$date_jour' group by id ORDER BY date_echeance;";
	$users11 = db_query($database_name, $sql);
