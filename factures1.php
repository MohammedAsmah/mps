...
/// update evaluations
	...
	<form id="form" name="form" method="post" action="factures1.php">
	...
	<? 
	$du = "2007-01-01";$au = "2014-04-26";
	
	
	$sql  = "SELECT * ";
	$sql .= "FROM factures29042014 where date_f between '$du' and '$au' ORDER BY id;";
...
<? $client=$users_["client"];$facture=$users_["numero"];$f=$users_["numero"];$d=$users_["date_f"];$client_se=Trim($client);

	$sql1  = "SELECT * ";
	$sql1 .= "FROM factures where numero='$facture' ORDER BY id;";
	$users1 = db_query($database_name, $sql1);$non_favoris=0;$erreur="2015-12-31";
