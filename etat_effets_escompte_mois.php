<?php
	...
	<form id="form" name="form" method="post" action="etat_effets_escompte_mois.php">
...
<? 	 $date=date("Y-m-d");$total=0;$date_jour=date("Y-m-d");
	...
	and date_echeance>'$date2' group by id ORDER BY date_echeance;";
	$users11 = db_query($database_name, $sql);
	
?>


<span style="font-size:24px"><?php echo "Effets Remis à L'escompte : ".$_POST['date1']." au ".$_POST['date2']; ?></span>
