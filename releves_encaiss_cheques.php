...
<?
	...
	<form id="form" name="form" method="post" action="releves_encaiss_cheques.php">
	...
	$de1=$_POST['date1'];$de2=$_POST['date2'];$vendeur=$_POST['vendeur'];
...
<p></p>
<tr><? echo "<td><a href=\"\\mps\\tutorial\\releve_encaiss_cheques.php?vendeur=$vendeur&date1=$date_d1&date2=$date_d2\">Imprimer Etat 1</a></td>";?>
</tr>
