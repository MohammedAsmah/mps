...
<?php
	...
	$sql .= "FROM commandes where week(NOW()) = week(date_e) and year(NOW()) = year(date_e) and vendeur='$vendeur' and evaluation<>'$encours' and evaluation<>'$vide' GROUP BY client order by total_net DESC;";
