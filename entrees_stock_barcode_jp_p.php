...
--></script>
	...
	<form id="form_user" name="form_user" method="post" action="entrees_stock_barcode_jp_p.php">
	
	<div>
	<h1 style="color:blue;"><?php echo $date_ins." ---->PRODUCTION PARTIELLE vers JAOUDA"; ?></h1>
...
<td><button type="button"  onClick="CheckUser()"><?php echo Translate("OK"); ?></button></td>
	...
	$sql .= "FROM entrees_stock where type='$type' and date='$dj' ORDER BY date_ins;";
